...
def tokenize_and_save(input_file, output_file, case_insensitive=False):
    """
    Tokenisiert den Text der Eingabedatei basierend auf dem NLTK-Tokenizer und speichert die Tokens in einer
    Ausgabedatei. Hierbei wird eine ggf. vorhandene Korrektur (in eckigen Klammern) am Ende eines Token entfernt.
    ...
    # NLTK zur Tokenisierung verwenden (Sprachabhängigkeit beachten: Text in deutscher Sprache)
